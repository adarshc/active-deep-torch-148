...
function train()
   ...
   local correct_predictions = 0
    ...
    if active_learning_flag then
      ...
      top_k_values, top_k_indices = confidence_measures:topk(samples_added_per_update, true)
...
while true do
  if initial_training_counter > 0 then
    ...
    --  epoch_per_update = 5
    --end
    print('[training using least confidence method...]')
    train()
    print('[testing using least confidence method...]')
    test()
  end
end
--net:evaluate()
